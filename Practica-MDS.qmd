...
Ahora, como las cuatro matrices son de similitud, aplicaremos una función a cada una de ellas para pasar obtener las matrices de distancias. Aplicamos la función siguiente:
